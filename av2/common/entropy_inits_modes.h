...
static const avm_cdf_prob
    default_inter_single_mode_cdf[INTER_MODE_CONTEXTS][CDF_SIZE(3)] = {
      { AVM_CDF3(10043, 11100), 6 }, { AVM_CDF3(21561, 21758), 1 },
      { AVM_CDF3(25411, 25714), 0 }, { AVM_CDF3(14117, 14341), 0 },
      { AVM_CDF3(18288, 18577), 0 },
    };

static const avm_cdf_prob
    default_inter_warp_mode_cdf[WARPMV_MODE_CONTEXT][CDF_SIZE(2)] = {
      { AVM_CDF2(25999), 1 }, { AVM_CDF2(14478), 7 }, { AVM_CDF2(10868), 6 },
      { AVM_CDF2(5256), 31 }, { AVM_CDF2(2722), 31 },
    };
...
static const avm_cdf_prob
    default_refinemv_flag_cdf[NUM_REFINEMV_CTX][CDF_SIZE(2)] = {
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(20204), 25 },
      { AVM_CDF2(17614), 43 }, { AVM_CDF2(24443), 32 }, { AVM_CDF2(16384), 0 },
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
...
static const avm_cdf_prob default_drl_cdf[DRL_CDF_TYPES][DRL_MODE_CONTEXTS]
                                         [CDF_SIZE(2)] = {
                                           {
                                               { AVM_CDF2(15721), 90 },
                                               { AVM_CDF2(21115), 0 },
...
static const avm_cdf_prob default_use_optflow_cdf[OPFL_MODE_CONTEXTS]
                                                 [CDF_SIZE(2)] = {
                                                   { AVM_CDF2(11582), 31 },
                                                   { AVM_CDF2(24076), 26 },
                                                 };
...
static const avm_cdf_prob default_cwp_idx_cdf[MAX_CWP_CONTEXTS][MAX_CWP_NUM - 1]
                                             [CDF_SIZE(2)] = {
                                               {
                                                   { AVM_CDF2(21704), 56 },
                                                   { AVM_CDF2(15990), 31 },
...
static const avm_cdf_prob default_wedge_dist_cdf[CDF_SIZE(4)] = {
  AVM_CDF4(8203, 16994, 21032), 75
};

static const avm_cdf_prob default_wedge_dist_cdf2[CDF_SIZE(3)] = {
  AVM_CDF3(14463, 19115), 75
};

static const avm_cdf_prob default_warp_interintra_cdf[BLOCK_SIZE_GROUPS]
                                                     [CDF_SIZE(2)] = {
                                                       { AVM_CDF2(16384), 0 },
                                                       { AVM_CDF2(27980), 56 },
                                                       { AVM_CDF2(29163), 56 },
...
static const avm_cdf_prob default_interintra_cdf[BLOCK_SIZE_GROUPS]
                                                [CDF_SIZE(2)] = {
                                                  { AVM_CDF2(20569), 1 },
                                                  { AVM_CDF2(17106), 1 },
                                                  { AVM_CDF2(20948), 1 },
...
static const avm_cdf_prob default_warp_ref_idx0_cdf[WARP_REF_CONTEXTS]
                                                   [CDF_SIZE(2)] = {
                                                     { AVM_CDF2(18903), 0 },
                                                   };

static const avm_cdf_prob default_warp_ref_idx1_cdf[WARP_REF_CONTEXTS]
                                                   [CDF_SIZE(2)] = {
                                                     { AVM_CDF2(24500), 90 },
                                                   };

static const avm_cdf_prob default_warp_ref_idx2_cdf[WARP_REF_CONTEXTS]
                                                   [CDF_SIZE(2)] = {
                                                     { AVM_CDF2(25360), 75 },
                                                   };

static const avm_cdf_prob default_warp_causal_cdf[WARP_CAUSAL_MODE_CTX]
                                                 [CDF_SIZE(2)] = {
                                                   { AVM_CDF2(14877), 1 },
                                                   { AVM_CDF2(12801), 0 },
                                                   { AVM_CDF2(6885), 6 },
...
static const avm_cdf_prob
    default_warp_precision_idx_cdf[BLOCK_SIZES_ALL][CDF_SIZE(2)] = {
      { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(31107), 56 }, { AVM_CDF2(27357), 31 }, { AVM_CDF2(26435), 26 },
      { AVM_CDF2(22585), 26 }, { AVM_CDF2(20146), 27 }, { AVM_CDF2(18671), 32 },
      { AVM_CDF2(18210), 32 }, { AVM_CDF2(17968), 25 }, { AVM_CDF2(17451), 40 },
      { AVM_CDF2(16736), 25 }, { AVM_CDF2(16040), 25 }, { AVM_CDF2(15633), 25 },
      { AVM_CDF2(13952), 25 }, { AVM_CDF2(14893), 25 }, { AVM_CDF2(13323), 25 },
      { AVM_CDF2(11830), 50 }, { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(21783), 28 }, { AVM_CDF2(20345), 15 }, { AVM_CDF2(19398), 25 },
      { AVM_CDF2(17823), 35 }, { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
      { AVM_CDF2(20066), 25 }, { AVM_CDF2(18893), 5 },
    };
...
static const avm_cdf_prob default_warp_extend_cdf[WARP_EXTEND_CTX]
                                                 [CDF_SIZE(2)] = {
                                                   { AVM_CDF2(20359), 0 },
                                                   { AVM_CDF2(20310), 75 },
                                                   { AVM_CDF2(21759), 75 },
...
static const avm_cdf_prob default_explicit_bawp_cdf[BAWP_SCALES_CTX_COUNT]
                                                   [CDF_SIZE(2)] = {
                                                     { AVM_CDF2(26966), 31 },
                                                     { AVM_CDF2(15275), 6 },
                                                     { AVM_CDF2(14613), 31 },
...
static const avm_cdf_prob default_palette_y_size_cdf[CDF_SIZE(7)] = {
  AVM_CDF7(8779, 15095, 20777, 24903, 27923, 30403), 32
};
...
static const avm_cdf_prob
    default_comp_inter_cdf[COMP_INTER_CONTEXTS][CDF_SIZE(2)] = {
      { AVM_CDF2(26924), 15 }, { AVM_CDF2(25000), 1 }, { AVM_CDF2(17949), 1 },
      { AVM_CDF2(13581), 6 },  { AVM_CDF2(7034), 0 },
    };

static const avm_cdf_prob default_single_ref_cdf[REF_CONTEXTS]
...
static const avm_cdf_prob default_comp_ref0_cdf[REF_CONTEXTS]
                                               [INTER_REFS_PER_FRAME - 1]
                                               [CDF_SIZE(2)] = {
                                                 {
                                                     { AVM_CDF2(9272), 32 },
...
static const avm_cdf_prob
    default_comp_group_idx_cdfs[COMP_GROUP_IDX_CONTEXTS][CDF_SIZE(2)] = {
      { AVM_CDF2(17510), 26 }, { AVM_CDF2(10382), 0 }, { AVM_CDF2(8336), 31 },
      { AVM_CDF2(6054), 1 },   { AVM_CDF2(5764), 5 },  { AVM_CDF2(7154), 10 },
      { AVM_CDF2(15013), 26 }, { AVM_CDF2(8426), 0 },  { AVM_CDF2(8278), 1 },
      { AVM_CDF2(4856), 1 },   { AVM_CDF2(3464), 0 },  { AVM_CDF2(5295), 0 },
    };

static const avm_cdf_prob default_skip_mode_cdfs[SKIP_MODE_CONTEXTS]
                                                [CDF_SIZE(2)] = {
                                                  { AVM_CDF2(30964), 93 },
                                                  { AVM_CDF2(21769), 0 },
                                                  { AVM_CDF2(12484), 15 },
...
static const avm_cdf_prob default_skip_txfm_cdfs[SKIP_CONTEXTS][CDF_SIZE(2)] = {
  { AVM_CDF2(25865), 25 }, { AVM_CDF2(14316), 0 }, { AVM_CDF2(4598), 0 },
  { AVM_CDF2(25612), 6 },  { AVM_CDF2(12366), 1 }, { AVM_CDF2(3320), 90 },
};

static const avm_cdf_prob default_bru_mode_cdf[CDF_SIZE(3)] = {
  AVM_CDF3(4124, 16615), 0
};

static const avm_cdf_prob default_intra_inter_cdf[INTRA_INTER_CONTEXTS]
                                                 [CDF_SIZE(2)] = {
                                                   { AVM_CDF2(1522), 1 },
                                                   { AVM_CDF2(14381), 0 },
                                                   { AVM_CDF2(10455), 25 },
...
static const avm_cdf_prob default_wienerns_length_cdf[WIENERNS_LENGTH_CTXS]
                                                     [CDF_SIZE(2)] = {
                                                       { AVM_CDF2(4898), 56 },
                                                       { AVM_CDF2(6088), 26 },
                                                     };
...
static const avm_cdf_prob default_ccso_cdf[CCSO_PLANES][CCSO_CONTEXT]
                                          [CDF_SIZE(2)] = {
                                            {
                                                { AVM_CDF2(18469), 62 },
                                                { AVM_CDF2(16384), 0 },
...
static const avm_cdf_prob
    default_cdef_cdf[CDEF_STRENGTHS_NUM - 1][CDF_SIZE(7)] = {
      { AVM_CDF2(17708), 32 },
...
static const avm_cdf_prob default_gdf_cdf[CDF_SIZE(2)] = { AVM_CDF2(14593),
                                                           32 };
...
static const avm_cdf_prob default_multi_line_mrl_cdf[MRL_INDEX_CONTEXTS]
                                                    [CDF_SIZE(2)] = {
                                                      { AVM_CDF2(19678), 6 },
                                                      { AVM_CDF2(12287), 6 },
                                                      { AVM_CDF2(9574), 6 },
...
static const avm_cdf_prob default_dpcm_cdf[CDF_SIZE(2)] = { AVM_CDF2(16384),
                                                            0 };
...
static const avm_cdf_prob default_dpcm_uv_cdf[CDF_SIZE(2)] = { AVM_CDF2(16384),
                                                               0 };
...
static const avm_cdf_prob default_cfl_sign_cdf[CDF_SIZE(8)] = {
  AVM_CDF8(2421, 4332, 11256, 12766, 21386, 28725, 32087), 62
};
...
static const avm_cdf_prob
    default_switchable_interp_cdf[SWITCHABLE_FILTER_CONTEXTS][CDF_SIZE(3)] = {
      { AVM_CDF3(29975, 32748), 25 }, { AVM_CDF3(2076, 32703), 75 },
      { AVM_CDF3(19, 1768), 15 },     { AVM_CDF3(17314, 27415), 31 },
      { AVM_CDF3(31286, 31994), 0 },  { AVM_CDF3(9581, 32608), 31 },
      { AVM_CDF3(535, 1036), 0 },     { AVM_CDF3(24819, 27722), 31 },
      { AVM_CDF3(10923, 21845), 0 },  { AVM_CDF3(10923, 21845), 0 },
      { AVM_CDF3(10923, 21845), 0 },  { AVM_CDF3(10923, 21845), 0 },
      { AVM_CDF3(10923, 21845), 0 },  { AVM_CDF3(10923, 21845), 0 },
      { AVM_CDF3(10923, 21845), 0 },  { AVM_CDF3(10923, 21845), 0 },
    };
...
static const avm_cdf_prob default_delta_q_cdf[CDF_SIZE(8)] = {
  AVM_CDF8(16594, 23325, 26424, 28225, 29358, 30099, 30613), 56
};
...
static const avm_cdf_prob
    default_inter_tx_type_set_cdf[INTER_TX_TYPE_SIGNALING_SETS][EOB_TX_CTXS]
...
static const avm_cdf_prob
    default_inter_ext_tx_cdf[EXT_TX_SETS_INTER][EOB_TX_CTXS][EXT_TX_SIZES]
                            [CDF_SIZE(16)] = {
                              {
                                  {
                                      { 0 },
...
static const avm_cdf_prob default_cctx_type_cdf[CDF_SIZE(7)] = {
  AVM_CDF7(14350, 14836, 16054, 17075, 19408, 28530), 62
};
...
static const avm_cdf_prob
    default_pb_mv_precision_cdf[MV_PREC_DOWN_CONTEXTS]
                               [NUM_PB_FLEX_QUALIFIED_MAX_PREC][CDF_SIZE(3)] = {
                                 {
                                     { AVM_CDF3(10923, 21845), 0 },
...
static const avm_cdf_prob
    default_do_split_cdf[PARTITION_STRUCTURE_NUM][PARTITION_CONTEXTS]
                        [CDF_SIZE(2)] = {
                          {
                              { AVM_CDF2(28084), 3 },  { AVM_CDF2(23755), 93 },
                              { AVM_CDF2(23634), 93 }, { AVM_CDF2(19368), 3 },
                              { AVM_CDF2(24961), 0 },  { AVM_CDF2(14941), 1 },
                              { AVM_CDF2(16154), 1 },  { AVM_CDF2(5905), 0 },
                              { AVM_CDF2(21934), 0 },  { AVM_CDF2(10440), 26 },
                              { AVM_CDF2(11984), 31 }, { AVM_CDF2(3474), 0 },
                              { AVM_CDF2(20492), 16 }, { AVM_CDF2(6963), 6 },
                              { AVM_CDF2(8099), 26 },  { AVM_CDF2(1529), 0 },
                              { AVM_CDF2(24117), 92 }, { AVM_CDF2(7871), 10 },
                              { AVM_CDF2(23604), 2 },  { AVM_CDF2(8429), 30 },
                              { AVM_CDF2(27356), 2 },  { AVM_CDF2(22441), 7 },
                              { AVM_CDF2(8897), 31 },  { AVM_CDF2(6811), 61 },
                              { AVM_CDF2(17592), 16 }, { AVM_CDF2(5648), 32 },
                              { AVM_CDF2(5339), 26 },  { AVM_CDF2(1082), 26 },
                              { AVM_CDF2(26143), 77 }, { AVM_CDF2(11379), 85 },
                              { AVM_CDF2(20142), 93 }, { AVM_CDF2(7401), 8 },
                              { AVM_CDF2(26235), 82 }, { AVM_CDF2(23674), 78 },
                              { AVM_CDF2(12441), 77 }, { AVM_CDF2(10482), 75 },
                              { AVM_CDF2(20663), 0 },  { AVM_CDF2(4192), 27 },
                              { AVM_CDF2(5274), 33 },  { AVM_CDF2(713), 1 },
                              { AVM_CDF2(28255), 75 }, { AVM_CDF2(27370), 75 },
                              { AVM_CDF2(23527), 0 },  { AVM_CDF2(20990), 1 },
                              { AVM_CDF2(26727), 0 },  { AVM_CDF2(21187), 0 },
                              { AVM_CDF2(25324), 0 },  { AVM_CDF2(17838), 0 },
                              { AVM_CDF2(26136), 0 },  { AVM_CDF2(16591), 6 },
                              { AVM_CDF2(19838), 1 },  { AVM_CDF2(10605), 31 },
                              { AVM_CDF2(22914), 1 },  { AVM_CDF2(12609), 31 },
                              { AVM_CDF2(11341), 0 },  { AVM_CDF2(4556), 0 },
                              { AVM_CDF2(24218), 1 },  { AVM_CDF2(13059), 7 },
                              { AVM_CDF2(15378), 32 }, { AVM_CDF2(5858), 32 },
                              { AVM_CDF2(21644), 32 }, { AVM_CDF2(7767), 31 },
                              { AVM_CDF2(8309), 6 },   { AVM_CDF2(1687), 0 },
                          },
                          {
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(25554), 0 },  { AVM_CDF2(18892), 0 },
                              { AVM_CDF2(18530), 0 },  { AVM_CDF2(10806), 6 },
                              { AVM_CDF2(22504), 1 },  { AVM_CDF2(12140), 31 },
                              { AVM_CDF2(11966), 31 }, { AVM_CDF2(4984), 30 },
                              { AVM_CDF2(24460), 31 }, { AVM_CDF2(8698), 31 },
                              { AVM_CDF2(9655), 31 },  { AVM_CDF2(2563), 30 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              ...
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(26227), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(17669), 1 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(26179), 1 },  { AVM_CDF2(17889), 1 },
                              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                              { AVM_CDF2(23500), 1 },  { AVM_CDF2(13115), 31 },
                              { AVM_CDF2(15253), 31 }, { AVM_CDF2(6458), 55 },
                              { AVM_CDF2(22566), 31 }, { AVM_CDF2(11497), 32 },
                              { AVM_CDF2(10045), 31 }, { AVM_CDF2(3750), 26 },
                          },
                        };
...
static const avm_cdf_prob
    default_rect_type_cdf[PARTITION_STRUCTURE_NUM][PARTITION_CONTEXTS]
                         [CDF_SIZE(2)] = {
                           {
                               { AVM_CDF2(14644), 0 },  { AVM_CDF2(10173), 75 },
                               { AVM_CDF2(18529), 0 },  { AVM_CDF2(16071), 90 },
                               { AVM_CDF2(20263), 1 },  { AVM_CDF2(12813), 1 },
                               { AVM_CDF2(26612), 0 },  { AVM_CDF2(23277), 1 },
                               { AVM_CDF2(10594), 76 }, { AVM_CDF2(7000), 75 },
                               { AVM_CDF2(20002), 1 },  { AVM_CDF2(12889), 2 },
                               { AVM_CDF2(13854), 76 }, { AVM_CDF2(10750), 1 },
                               { AVM_CDF2(18380), 1 },  { AVM_CDF2(17505), 6 },
                               { AVM_CDF2(14430), 7 },  { AVM_CDF2(11554), 2 },
                               { AVM_CDF2(20078), 1 },  { AVM_CDF2(19097), 76 },
                               { AVM_CDF2(15278), 2 },  { AVM_CDF2(10137), 1 },
                               { AVM_CDF2(21921), 7 },  { AVM_CDF2(14621), 6 },
                               { AVM_CDF2(19330), 2 },  { AVM_CDF2(15921), 1 },
                               { AVM_CDF2(26218), 1 },  { AVM_CDF2(24318), 1 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16066), 78 }, { AVM_CDF2(9225), 2 },
                               { AVM_CDF2(22849), 31 }, { AVM_CDF2(14817), 11 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(18543), 75 }, { AVM_CDF2(13210), 10 },
                               { AVM_CDF2(24367), 32 }, { AVM_CDF2(18417), 25 },
                               { AVM_CDF2(24701), 6 },  { AVM_CDF2(18911), 7 },
                               { AVM_CDF2(29590), 1 },  { AVM_CDF2(27778), 7 },
                               { AVM_CDF2(3400), 1 },   { AVM_CDF2(935), 90 },
                               { AVM_CDF2(10365), 32 }, { AVM_CDF2(1723), 1 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                           },
                           {
                               { AVM_CDF2(15654), 76 }, { AVM_CDF2(13500), 75 },
                               { AVM_CDF2(19177), 91 }, { AVM_CDF2(14739), 90 },
                               { AVM_CDF2(18769), 75 }, { AVM_CDF2(13500), 1 },
                               { AVM_CDF2(23583), 75 }, { AVM_CDF2(20927), 75 },
                               { AVM_CDF2(15045), 1 },  { AVM_CDF2(10528), 0 },
                               { AVM_CDF2(22474), 6 },  { AVM_CDF2(14250), 0 },
                               { AVM_CDF2(16561), 75 }, { AVM_CDF2(11427), 76 },
                               { AVM_CDF2(21874), 6 },  { AVM_CDF2(16344), 90 },
                               { AVM_CDF2(21566), 31 }, { AVM_CDF2(13357), 2 },
                               { AVM_CDF2(27355), 1 },  { AVM_CDF2(24117), 6 },
                               { AVM_CDF2(10901), 77 }, { AVM_CDF2(5780), 0 },
                               { AVM_CDF2(19056), 37 }, { AVM_CDF2(9141), 1 },
                               { AVM_CDF2(20436), 7 },  { AVM_CDF2(15693), 32 },
                               { AVM_CDF2(26536), 6 },  { AVM_CDF2(23667), 31 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               ...
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(19241), 7 },  { AVM_CDF2(13038), 32 },
                               { AVM_CDF2(28903), 32 }, { AVM_CDF2(24802), 32 },
                               { AVM_CDF2(9097), 32 },  { AVM_CDF2(2749), 6 },
                               { AVM_CDF2(15201), 27 }, { AVM_CDF2(4449), 6 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                               { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
                           },
                         };
      ...
      {
          {
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(31091), 3 },  { AVM_CDF2(29638), 0 },
              { AVM_CDF2(28924), 0 },  { AVM_CDF2(28653), 0 },
              { AVM_CDF2(30349), 93 }, { AVM_CDF2(28265), 75 },
              { AVM_CDF2(27287), 0 },  { AVM_CDF2(27721), 0 },
              { AVM_CDF2(29960), 93 }, { AVM_CDF2(28345), 90 },
              { AVM_CDF2(27302), 90 }, { AVM_CDF2(27252), 75 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(30342), 1 },  { AVM_CDF2(27563), 6 },
              { AVM_CDF2(26168), 6 },  { AVM_CDF2(23089), 32 },
              { AVM_CDF2(30643), 0 },  { AVM_CDF2(28683), 1 },
              { AVM_CDF2(28009), 0 },  { AVM_CDF2(26186), 0 },
              { AVM_CDF2(29222), 1 },  { AVM_CDF2(25740), 0 },
              { AVM_CDF2(24079), 6 },  { AVM_CDF2(19806), 76 },
              { AVM_CDF2(29409), 90 }, { AVM_CDF2(26825), 93 },
              { AVM_CDF2(25919), 93 }, { AVM_CDF2(24417), 93 },
          },
      },
      {
          {
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(26866), 30 }, { AVM_CDF2(24499), 25 },
              { AVM_CDF2(24732), 31 }, { AVM_CDF2(23387), 25 },
              { AVM_CDF2(27477), 30 }, { AVM_CDF2(25837), 31 },
              { AVM_CDF2(24621), 31 }, { AVM_CDF2(23604), 5 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(24384), 26 }, { AVM_CDF2(22113), 32 },
              { AVM_CDF2(21798), 2 },  { AVM_CDF2(20067), 6 },
              { AVM_CDF2(26220), 31 }, { AVM_CDF2(22997), 30 },
              { AVM_CDF2(22249), 31 }, { AVM_CDF2(20091), 0 },
          },
      },
    };
      ...
      {
          {
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(25789), 31 }, { AVM_CDF2(25290), 32 },
              { AVM_CDF2(24270), 31 }, { AVM_CDF2(22994), 31 },
              { AVM_CDF2(25801), 1 },  { AVM_CDF2(25260), 7 },
              { AVM_CDF2(24041), 1 },  { AVM_CDF2(24281), 1 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(23038), 6 },  { AVM_CDF2(19972), 40 },
              { AVM_CDF2(19723), 8 },  { AVM_CDF2(17939), 0 },
              { AVM_CDF2(15574), 6 },  { AVM_CDF2(13761), 76 },
              { AVM_CDF2(12917), 91 }, { AVM_CDF2(11328), 75 },
              { AVM_CDF2(17295), 32 }, { AVM_CDF2(14463), 38 },
              { AVM_CDF2(14724), 6 },  { AVM_CDF2(11653), 1 },
              { AVM_CDF2(13202), 32 }, { AVM_CDF2(10929), 7 },
              { AVM_CDF2(10348), 7 },  { AVM_CDF2(8276), 1 },
          },
      },
      {
          {
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(24728), 31 }, { AVM_CDF2(22673), 31 },
              { AVM_CDF2(21033), 6 },  { AVM_CDF2(20321), 1 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              ...
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(16384), 0 },  { AVM_CDF2(16384), 0 },
              { AVM_CDF2(24631), 67 }, { AVM_CDF2(21363), 15 },
              { AVM_CDF2(20201), 15 }, { AVM_CDF2(17529), 82 },
              { AVM_CDF2(21042), 3 },  { AVM_CDF2(18640), 80 },
              { AVM_CDF2(18183), 91 }, { AVM_CDF2(15590), 76 },
          },
      },
    };
...
static const avm_cdf_prob default_most_probable_stx_set_cdf[CDF_SIZE(7)] = {
  AVM_CDF7(20712, 26263, 30623, 32732, 32736, 32740), 55
};

static const avm_cdf_prob default_most_probable_stx_set_cdf_ADST_ADST[CDF_SIZE(
    4)] = { AVM_CDF4(15897, 26144, 30010), 5 };

static const avm_cdf_prob
    default_txfm_do_partition_cdf[FSC_MODES][TX_PARTITION_DIRS]
...
static const avm_cdf_prob default_region_type_cdf[INTER_SDP_BSIZE_GROUP]
                                                 [CDF_SIZE(2)] = {
                                                   { AVM_CDF2(2635), 25 },
                                                   { AVM_CDF2(883), 25 },
                                                   { AVM_CDF2(503), 50 },
...
static const avm_cdf_prob default_morph_pred_cdf[MORPH_PRED_CTXS]
                                                [CDF_SIZE(2)] = {
                                                  { AVM_CDF2(31715), 55 },
                                                  { AVM_CDF2(19667), 1 },
                                                  { AVM_CDF2(10555), 91 },
...
static const avm_cdf_prob default_segment_pred_cdf[SEG_TEMPORAL_PRED_CTXS]
                                                  [CDF_SIZE(2)] = {
                                                    { AVM_CDF2(16384), 0 },
                                                    { AVM_CDF2(16384), 0 },
                                                    { AVM_CDF2(16384), 0 },
...
static const avm_cdf_prob default_seg_id_ext_flag_cdf[SPATIAL_PREDICTION_PROBS]
                                                     [CDF_SIZE(2)] = {
                                                       { AVM_CDF2(16384), 0 },
                                                       { AVM_CDF2(16384), 0 },
                                                       { AVM_CDF2(16384), 0 },
...
static const avm_cdf_prob default_intra_dip_mode_n6_cdf[CDF_SIZE(6)] = {
  AVM_CDF6(5753, 15408, 19070, 22631, 27578), 0
};
