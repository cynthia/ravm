...
typedef enum {
  OBU_METADATA_TYPE_AVM_RESERVED_0,
  OBU_METADATA_TYPE_HDR_CLL,
  OBU_METADATA_TYPE_HDR_MDCV,
  OBU_METADATA_TYPE_ITUT_T35,
  OBU_METADATA_TYPE_TIMECODE,
  OBU_METADATA_TYPE_DECODED_FRAME_HASH,
  OBU_METADATA_TYPE_BANDING_HINTS,
  OBU_METADATA_TYPE_ICC_PROFILE,
  OBU_METADATA_TYPE_SCAN_TYPE,
  OBU_METADATA_TYPE_TEMPORAL_POINT_INFO,
